...
class Swerve : SubsystemBase() {
	companion object {
		...
		val maxModVel = maxLinVel
		val maxAngVel = Math.PI * 2.0
	}
	...
	override fun periodic() {
		...
		SmartDashboard.putNumber("Max theor. Speed", Module.driveFreeSpeed)
		getGravity().let {
	...
	class Module(driveCanId: Int, turnCanId: Int, val chassisAngularOffset: Double) {
		...
		private val driveM = CANSparkMax(driveCanId, MotorType.kBrushless).apply {
		...
		private val driveE = driveM.getEncoder().apply {
